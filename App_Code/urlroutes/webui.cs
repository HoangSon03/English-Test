...
public class webui
{
    ...
    public List<string> UrlRoutes()
    {
        ...
        //Trắc Nghiệm Details Listening B1
        ...
        list.Add("webBaiKiemTraDetalsListening|bai-kiem-tra-listening-{id_khoi}/bai-kiem-tra-chi-tiet/{title}/{id_test}.html|~/web_module/web_TracNghiemListening_Version2.aspx");
        //Trắc Nghiệm Writing
        ...
        list.Add("webBaiKiemTraReading|bai-kiem-tra-reading-{id_khoi}/bai-kiem-tra-chi-tiet/{title}/{id_test}.html|~/web_module/web_TracNghiemReading_Version2.aspx");
        ...
        list.Add("webBaiLuyenTapDetalsAccess|truy-cap-bai-luyen-tap-chi-tiet-{id_khoi}-{user_id}/{name}-{id_test}.html|~/web_module/web_LuyenTapDetails.aspx");
        //kết quả kiểm tra
        //list.Add("webResultTest|ket-qua-bai-kiem-tra.html|~/web_module/web_BangDiem.aspx");
        list.Add("webResultTest|ket-qua-bai-kiem-tra|~/web_module/web_BangDiem_Version2.aspx");
        list.Add("webResultLuyentap|ket-qua-bai-luyen-tap|~/web_module/web_luyentap/web_KetQuaLuyenTap.aspx");
        list.Add("webbaikiemtratienganh|bai-kiem-tra-b1-{chapter_id}|~/web_module/web_TracNghiemListTest.aspx");


        //module luyện tập
        list.Add("webdanhsachbailuyentap|exercise-list-test-{kynang}|~/web_module/web_luyentap/web_DanhSachDeLuyenTap.aspx");
        list.Add("webluyentapreadingb1|exercise-reading-b1-de-{de_id}-test-{test_id}|~/web_module/web_luyentap/web_BaiLuyenTap_ReadingB1.aspx");
        list.Add("webluyentaplisteningb1|exercise-listening-b1-de-{de_id}-test-{test_id}|~/web_module/web_luyentap/web_BaiLuyenTap_ListeningB1.aspx");
        list.Add("webluyentapreadinga1|exercise-reading-a2-de-{de_id}-test-{test_id}|~/web_module/web_luyentap/web_BaiLuyenTap_ReadingA2.aspx");
        list.Add("webluyentaplisteninga1|exercise-listening-a2-de-{de_id}-test-{test_id}|~/web_module/web_luyentap/web_BaiLuyenTap_ListeningA2.aspx");
        return list;
