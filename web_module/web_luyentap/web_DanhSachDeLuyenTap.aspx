<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterPage.master" AutoEventWireup="true" CodeFile="web_DanhSachDeLuyenTap.aspx.cs" Inherits="web_module_web_luyentap_web_DanhSachDeLuyenTap" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hislider" Runat="Server">
  ...
  <%--  <div id="notification" class="notification">
        <p>Bài thi sẽ bắt đầu lúc 08:00 (05/11/2022)</p>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-12 sl sl-show mb-4 type1">
                            <div class="card card__tracnghiem">
                                ...
                                <div class="card-footer card-footer__test">
                                    <a class="button-53" href="<%#Eval("link_test") %>">Let's Go</a>
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
