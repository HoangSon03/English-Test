                                ...
                                <div class="Part2">
                                    <div id="div_Part6_De1" runat="server">
                                        ...
                                        <div class="Answer">
                                            <div>
                                                27 :
                                        <input data-dapan="IT" class="Answer-input" type="text" name="part6_12" autocomplete="off" />
                                            </div>
                                            <div>
                                                28 :
                                        <input data-dapan="MOST" class="Answer-input" type="text" id="giatri_11" name="part6_13" autocomplete="off" />
                                            </div>
                                            <div>
                                                29 :
                                        <input data-dapan="ALL" class="Answer-input" type="text" name="part6_14" autocomplete="off" />
                                            </div>
                                            <div>
                                                30 :
                                        <input data-dapan="FORWARD" class="Answer-input" type="text" name="part6_15" autocomplete="off" />
                                            </div>
                                            <div>
                                                31 :
                                        <input data-dapan="AT" class="Answer-input" type="text" name="part6_16" autocomplete="off" />
                                            </div>
                                            <div>
                                                32 :
                                        <input data-dapan="IF" class="Answer-input" type="text" name="part6_17" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                    <div id="div_Part6_De2" runat="server">
                                        ...
                                        <div class="Answer">
                                            <div>
                                                27 :
                                        <input data-dapan="be" class="Answer-input" type="text" name="part6_12" autocomplete="off" />
                                            </div>
                                            <div>
                                                28 :
                                        <input data-dapan="with" class="Answer-input" type="text" name="part6_13" autocomplete="off" />
                                            </div>
                                            <div>
                                                29 :
                                        <input data-dapan="of" class="Answer-input" type="text" name="part6_14" autocomplete="off" />
                                            </div>
                                            <div>
                                                30 :
                                        <input data-dapan="us" class="Answer-input" type="text" name="part6_15" autocomplete="off" />
                                            </div>
                                            <div>
                                                31 :
                                        <input data-dapan="to" class="Answer-input" type="text" name="part6_16" autocomplete="off" />
                                            </div>
                                            <div>
                                                32 :
                                        <input data-dapan="than" class="Answer-input" type="text" name="part6_17" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
