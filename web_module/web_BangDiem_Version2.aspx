<%@ Page Title="" Language="C#" MasterPageFile="~/WebMasterPage.master" AutoEventWireup="true" CodeFile="web_BangDiem_Version2.aspx.cs" Inherits="web_module_web_BangDiem_Version2" %>
...
<asp:Content ID="Content8" ContentPlaceHolderID="hibodywrapper" runat="Server">
    ...
    <div class="main-bangdiem" id="mainBangDiem">
        <%--<h3 style="color: blue; text-align: center; margin-top: 15px">Kết quả chưa được cập nhật. Vui lòng quay trở lại sau!</h3>--%>
