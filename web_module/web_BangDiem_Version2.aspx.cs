...
public partial class web_module_web_BangDiem_Version2 : System.Web.UI.Page
{
    ...
    protected void rpPopupChiTiet_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (checkMon == 74)// A2
        {
            ...
            if (checkDangBai.baithicate_name.ToLower().Contains("reading") || checkDangBai.baithicate_name.ToLower().Contains("writing"))
            {
                ...
                var getPart1 = (from ctkq in db.tbTracNghiem_ResultChiTiets
                                ...
                                where (ctkq.resulttest_id == listChecked && ctkq.result_part ==1)|| (ctkq.resulttest_id == listChecked && ctkq.result_part == 2)
                                || (ctkq.resulttest_id == listChecked && ctkq.result_part == 3)|| (ctkq.resulttest_id == listChecked && ctkq.result_part == 4)
                                select new
                                {
                ...
                var getPart2 = from rs in db.tbTracNghiem_ResultChiTiets
                               where rs.resulttest_id == listChecked && rs.result_part==5
                               select new
                               {
            ...
            else if (checkDangBai.baithicate_name.ToLower().Contains("listening"))
            {
                ...
                var getPart1 = (from ctkq in db.tbTracNghiem_ResultChiTiets
                                join ch in db.tbTracNghiem_EnglishQuestions on ctkq.question_id equals ch.englishquestion_id
                                where( ctkq.resulttest_id == listChecked && ctkq.result_part == 1)|| (ctkq.resulttest_id == listChecked && ctkq.result_part == 3)|| (ctkq.resulttest_id == listChecked && ctkq.result_part == 4)
                                select new
                                {
                                    result_id = ctkq.resultchitiet_id,
                                    noidungcauhoi = ch.englishquestion_content,//.Contains("style=") ? "<div class='content_image'>" + ch.englishquestion_content + "</div>" : ch.englishquestion_content.Contains(".jpg") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".png") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".mp3") ? " <audio controls> <source src = '" + ch.englishquestion_content + "'> </audio>" : ch.englishquestion_content,
                ...
                //get tự luận
                var getPart2 = from rs in db.tbTracNghiem_ResultChiTiets
                               where (rs.resulttest_id == listChecked && rs.result_part == 2) || (rs.resulttest_id == listChecked && rs.result_part == 5)
                               select new
                               {
                                   result_id = rs.resultchitiet_id,
                                   noidungcauhoi = "",
        ...
        else if (checkMon == 72) //B1
        {
            ...
            else if (checkDangBai.baithicate_name.ToLower().Contains("reading"))
            {
                //get trac nghiem
                var getPart1 = (from ctkq in db.tbTracNghiem_ResultChiTiets
                                join ch in db.tbTracNghiem_EnglishQuestions on ctkq.question_id equals ch.englishquestion_id
                                where (ctkq.resulttest_id == listChecked && ctkq.result_part == 1) || (ctkq.resulttest_id == listChecked && ctkq.result_part == 3) || (ctkq.resulttest_id == listChecked && ctkq.result_part == 5)
                                select new
                                {
                                    result_id = ctkq.resultchitiet_id,
                                    noidungcauhoi = ch.englishquestion_content,//.Contains("style=") ? "<div class='content_image'>" + ch.englishquestion_content + "</div>" : ch.englishquestion_content.Contains(".jpg") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".png") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".mp3") ? " <audio controls> <source src = '" + ch.englishquestion_content + "'> </audio>" : ch.englishquestion_content,
                ...
                //get tự luận
                var getPart2 = from rs in db.tbTracNghiem_ResultChiTiets
                               where (rs.resulttest_id == listChecked && rs.result_part == 2) ||(rs.resulttest_id == listChecked && rs.result_part == 4) ||(rs.resulttest_id == listChecked && rs.result_part == 6) // && rs.question_id == null
                               select new
                               {
                                   result_id = rs.resultchitiet_id,
                                   noidungcauhoi = "",
            ...
            else
            {
                ...
                var getPart1 = (from ctkq in db.tbTracNghiem_ResultChiTiets
                                join ch in db.tbTracNghiem_EnglishQuestions on ctkq.question_id equals ch.englishquestion_id
                                where (ctkq.resulttest_id == listChecked && ctkq.result_part == 1) || (ctkq.resulttest_id == listChecked && ctkq.result_part == 2) || (ctkq.resulttest_id == listChecked && ctkq.result_part == 4)
                                select new
                                {
                                    result_id = ctkq.resultchitiet_id,
                                    noidungcauhoi = ch.englishquestion_content,//.Contains("style=") ? "<div class='content_image'>" + ch.englishquestion_content + "</div>" : ch.englishquestion_content.Contains(".jpg") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".png") ? "<img class='tracnghiem-answer__image' src='" + ch.englishquestion_content + "'>" : ch.englishquestion_content.Contains(".mp3") ? " <audio controls> <source src = '" + ch.englishquestion_content + "'> </audio>" : ch.englishquestion_content,
                ...
                //get tự luận
                var getPart2 = from rs in db.tbTracNghiem_ResultChiTiets
                               where rs.resulttest_id == listChecked && rs.result_part == 3
                               select new
                               {
                                   result_id = rs.resultchitiet_id,
                                   noidungcauhoi = "",
