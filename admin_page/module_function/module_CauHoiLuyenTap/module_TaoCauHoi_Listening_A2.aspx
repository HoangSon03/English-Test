<%@ Page Language="C#" AutoEventWireup="true" CodeFile="module_TaoCauHoi_Listening_A2.aspx.cs" Inherits="admin_page_module_function_module_CauHoiLuyenTap_module_TaoCauHoi_Listening_A2" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="card card-block">
                        ...
                        <div class="form-group table-responsive">
                            <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="englishquestion_id">
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn Caption="Kyn năng" FieldName="kynang_name" HeaderStyle-HorizontalAlign="Center" Width="10%"></dx:GridViewDataColumn>
            ...
            <div class="col-sm-12" id="div_Part">
                ...
                <a href="javascript:void(0)" class="btn btn-primary" onclick="myPart3('2')">Part 2</a>
                <a href="javascript:void(0)" class="btn btn-primary" onclick="myPart1('3')">Part 3</a>
            ...
            <div class="form-group">
                ...
                <div class="col-8 form-group">
                   Title: <input type="text" id="txtTitle" runat="server" class="form-control" />
                </div>
            </div>
