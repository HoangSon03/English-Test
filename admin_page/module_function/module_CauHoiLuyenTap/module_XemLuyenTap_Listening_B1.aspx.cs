...
public partial class admin_page_module_function_module_CauHoiLuyenTap_module_XemLuyenTap_Listening_B1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.Cookies["UserName"] != null)
        {
            ...
            var getCHL = (from t in db.tbTracNghiem_Tests
                          ...
                          where (t.test_id == id_Test && qsb.questionbig_part == "1") || (t.test_id == id_Test && qsb.questionbig_part == "2")
                          select new
                          {
                              t.test_id,
                              qsb.QuestionBig_id,
            ...
            var getCHL_Part3 = (from t in db.tbTracNghiem_Tests
                                join qsb in db.tbTracNghiem_QuestionBigs on t.kynang_id equals qsb.lesson_id.ToString()
                                where t.test_id == id_Test && qsb.questionbig_part == "3"
                                select new
                                {
                                    t.test_id,
                                    qsb.QuestionBig_id,
            ...
            var getCHL_Part4 = (from t in db.tbTracNghiem_Tests
                                join qsb in db.tbTracNghiem_QuestionBigs on t.kynang_id equals qsb.lesson_id.ToString()
                                where t.test_id == id_Test && qsb.questionbig_part == "4"
                                select new
                                {
                                    t.test_id,
                                    qsb.QuestionBig_id,
