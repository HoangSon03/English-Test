<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_BaiLuyenTap_ChiTiet.aspx.cs" Inherits="admin_page_module_function_module_CauHoiLuyenTap_module_BaiLuyenTap_ChiTiet" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="hibodywrapper" runat="Server">
    <div class="card card-block">
        ...
        <div>
            <asp:Button Text="Lưu" CssClass="btn btn-primary" runat="server" ID="btnLuu" OnClick="btnLuu_Click" />
            <asp:Button Text="Quay lại" CssClass="btn btn-primary" runat="server" ID="btnQuayLai" OnClick="btnQuayLai_Click" />
        </div>
    </div>
</asp:Content>
