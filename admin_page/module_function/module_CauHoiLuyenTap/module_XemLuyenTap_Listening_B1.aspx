<%@ Page Language="C#" AutoEventWireup="true" CodeFile="module_XemLuyenTap_Listening_B1.aspx.cs" Inherits="admin_page_module_function_module_CauHoiLuyenTap_module_XemLuyenTap_Listening_B1" %>
    ...
    <form id="form1" runat="server">
        <script>
            ...
            function checkTuLuan() {
                ...
                for (var index = 0; index < getValues.length; index++) {
                    var dapandung = getValues[index].data("dapan").toString().toUpperCase().split('/');
