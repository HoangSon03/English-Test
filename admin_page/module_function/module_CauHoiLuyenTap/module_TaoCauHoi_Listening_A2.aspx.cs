...
public partial class admin_page_module_function_module_CauHoiLuyenTap_module_TaoCauHoi_Listening_A2 : System.Web.UI.Page
{
    ...
    private void themData()
    {
        ...
        if (audio != null)
        {
            ...
            content.questionbig_title = txtTitle.Value;
    ...
    private void updateData()
    {
        ...
        if (audio != null)
        {
            ...
            //up.questionbig_title = txtTitle.Value;
            db.SubmitChanges();
        }
    ...
    protected void btnLuuPart3_Click(object sender, EventArgs e)
    {
        if (Session["_id"].ToString() == "0")
        {
            ...
            else if (txtCau1.Value == "" || txtCau2.Value == "" || txtCau3.Value == "" || txtCau4.Value == "" || txtCau5.Value == "")
            {
                alert.alert_Warning(Page, "Vui lòng nhập đầy đủ câu hỏi", "");
            }
            else if (txtDapAn1.Value == "" || txtDapAn2.Value == "" || txtDapAn3.Value == "" || txtDapAn4.Value == "" || txtDapAn5.Value == "")
            {
    ...
    protected void btnChiTiet_Click(object sender, EventArgs e)
    {
        ...
        {
            if (chitiet.englishquestion_part == "1" || chitiet.englishquestion_part == "3" || chitiet.englishquestion_part == "4")
            {
                //get câu hỏi lớn
                var cauhoilon = (from q in db.tbTracNghiem_QuestionBigs
                                 where q.QuestionBig_id == chitiet.englishquestion_groupidquestion
