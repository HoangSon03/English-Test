<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="module_TaoBaiKiemTra_Version2.aspx.cs" Inherits="admin_page_module_function_module_BaiKiemTra_module_TaoBaiKiemTra_Version2" %>
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                   ...
                   <%-- <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="col-sm-2">
                            <asp:DropDownList ID="ddlLoaiBai" runat="server" CssClass="btn btn-primary" OnSelectedIndexChanged="ddlLoaiBai_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-3">
                            <asp:DropDownList ID="ddlKyNang" runat="server" CssClass="btn btn-primary" OnSelectedIndexChanged="ddlKyNang_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            <dx:ASPxGridLookup ID="lkChuong" runat="server" Visible="false" SelectionMode="Multiple" ClientInstanceName="lkChuong"
