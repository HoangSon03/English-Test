                            ...
                            <div class="form-group table-responsive">
                                <dx:ASPxGridView ID="grvList" runat="server" ClientInstanceName="grvList" KeyFieldName="englishquestion_id">
                                    <Columns>
                                        ...
                                        <dx:GridViewDataColumn Caption="Loại CH" FieldName="englishquestion_level" HeaderStyle-HorizontalAlign="Center" Width="10%"></dx:GridViewDataColumn>
                                        <dx:GridViewDataColumn Caption="Dạng CH" FieldName="englishquestion_dangcauhoi" HeaderStyle-HorizontalAlign="Center" Width="10%"></dx:GridViewDataColumn>
